...
<template>
  ...
  >
    ...
    <div class="flex items-center gap-3 p-4">
      ...
      <div class="flex items-center gap-1 px-2 py-1 bg-gray-50 rounded-lg border border-gray-200">
        <span class="text-sm text-gray-600 font-medium px-2">
        ...
        <div class="w-px h-4 bg-gray-300" />
        <button
          class="size-7 rounded-md flex items-center justify-center hover:bg-red-50 hover:text-red-600 transition-all duration-200 text-gray-500 cursor-pointer"
          title="Close (Escape)"
